...
@Service("fastway")
//@Qualifier("nationale")
public class FastwayRoadService implements RoadAdapterService<Road>{
	
	@Autowired
	private RoadRepository roadRepository;
	
	
	public FastwayRoadService() {
	}
	
	public FastwayRoadService(RoadRepository roadRepository) {
