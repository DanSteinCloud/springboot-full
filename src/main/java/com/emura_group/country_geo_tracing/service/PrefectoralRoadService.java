...
@Service("prefectoral")
public class PrefectoralRoadService implements RoadAdapterService<Road>{
	@Autowired
	private RoadRepository roadRepository;

	public PrefectoralRoadService() {
	}
	
	public PrefectoralRoadService(RoadRepository roadRepository) {
	...
	System.out.println("This is a prefectoral road creation - "  + _road.toString());
	return _road;
	}
